...
K = 1; % number of sampling vallues of para
N = 20; % number of basis functions
h = 30 * nu; % width of time window 180
...
for i_p = 7
    ...
    W(1:h, :) = [wt(end-h*sampling+1-offset:sampling:end-offset, :)]; 
...
ax1 = nexttile;
% figure;
plot(ax1, Yt_7_5WS.Time(1:50:end-offset2), Yt_7_5WS.Data(1:50:end-offset2)./power_base, 'r-', 'LineWidth', 1.2);
hold on
...
ax2 = nexttile;
plot(ax2, Yt_7_5WS.Time(1:50:end-offset2), abs(Yt_7_5WS.Data(1:50:end-offset2) - kappat)./abs(Yt_7_5WS.Data(1:50:end-offset2)), 'g:', 'LineWidth', 1.2);
hold on
xlim([82 142]);
grid on
% xlabel('$t$', 'interpreter', 'latex', 'fontsize', 15);
...
% xlabel('$t$', 'interpreter', 'latex', 'fontsize', 15);
ylabel('Active Power', 'Interpreter', 'latex', 'FontSize', 15);

subplot(2,1,2);
plot(Yt_7_5WS.Time(1:50:end-offset2), abs(Yt_7_5WS.Data(1:50:end-offset2) - kappat)./power_base, 'g:', 'LineWidth', 1.2);
hold on
xlim([85 135]);
grid on
xlabel('$t$', 'interpreter', 'latex', 'fontsize', 15);
ylabel('Absolute Error', 'Interpreter', 'latex', 'FontSize', 15);
legend('Absolute Errod', 'Interpreter', 'latex', 'FontSize', 12);
